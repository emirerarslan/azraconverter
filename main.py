...
class MainWindow(QMainWindow):
    ...
    def _launch_update_installer(self, installer_path):
        """Sessiz kurulum boyunca uygulamadan bağımsız durum penceresi gösterir."""
        ...
        helper.write_text(
            ...
            "$detail.Text = 'Bu işlem birkaç dakika sürebilir.'\r\n"
            "$detail.Font = New-Object System.Drawing.Font('Segoe UI', 8)\r\n"
            "$detail.ForeColor = [System.Drawing.Color]::FromArgb(157, 146, 127)\r\n"
            "$detail.AutoSize = $true\r\n"
            "$detail.Location = New-Object System.Drawing.Point(26, 82)\r\n"
            "$form.Controls.AddRange(@($title, $status, $detail))\r\n"
            "$form.Show()\r\n"
    ...
    def _launch_in_app_update(self, package_path):
        ...
        helper.write_text(
            ...
            "$form = New-Object System.Windows.Forms.Form\r\n"
            "$form.Text = 'ConverteR Güncellemesi'\r\n"
            "$form.Size = New-Object System.Drawing.Size(390, 145)\r\n"
            "$form.StartPosition = 'CenterScreen'\r\n"
            "$form.FormBorderStyle = 'FixedDialog'\r\n"
            "$form.ControlBox = $false\r\n"
            "$form.TopMost = $true\r\n"
            ...
            "$detail.ForeColor = [System.Drawing.Color]::FromArgb(157, 146, 127)\r\n"
            "$detail.AutoSize = $true\r\n"
            "$detail.Location = New-Object System.Drawing.Point(25, 60)\r\n"
            "$form.Controls.AddRange(@($status, $detail))\r\n"
            "$form.Show()\r\n"
            "[System.Windows.Forms.Application]::DoEvents()\r\n"
            "try {\r\n"
            f"  Wait-Process -Id {os.getpid()} -ErrorAction SilentlyContinue\r\n"
